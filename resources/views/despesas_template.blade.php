...
<body>
    ...
    <div href=""  class="btn btn-light">Desepesas do Contrato #{{ $contrato }}</div>&nbsp;
        <a href="#"  class="btn btn-primary">Listar Despesas</a>&nbsp;
        <a href="#"  class="btn btn-primary">Cadastrar Nova Despesa</a>
    </nav>
