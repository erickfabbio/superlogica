...
<table class="table table-bordered">
    ...
    @foreach ($pessoas->data as $pessoa)
        <tr>
            <td>{{ $pessoa->st_nome_pes }}</td>
            <td>{{ $pessoa->st_telefone_pes }} / {{ $pessoa->st_celular_pes }}</td>
            <th scope="row">
                <a href="{{ url("/pessoas/".$pessoa->id_pessoa_pes."/editar") }}" class="btn btn-xs btn-primary btn-action">
